...
void _productSerialize(
  ...
  writer.writeLong(offsets[3], object.thid);
...
Product _productDeserialize(
  ...
  object.thid = reader.readLong(offsets[3]);
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> thidEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'thid',
        value: value,
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> thidGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> thidLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> thidBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProductQuerySortBy on QueryBuilder<Product, Product, QSortBy> {
  ...
  QueryBuilder<Product, Product, QAfterSortBy> sortByThid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'thid', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByThidDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'thid', Sort.desc);
    });
  }
...
extension ProductQuerySortThenBy
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByThid() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'thid', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByThidDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'thid', Sort.desc);
    });
  }
...
extension ProductQueryWhereDistinct
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByThid() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'thid');
    });
  }
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, int, QQueryOperations> thidProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'thid');
    });
  }
